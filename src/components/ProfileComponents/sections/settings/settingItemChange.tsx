...
export default function SettingItemChange( {title} : ISettingItemChange) {
  return (
    <div className='h-[30px] border-b border-b-black flex justify-between items-center'>
        ...
        <div className='rounded-full h-[24px] w-[24px] bg-[#D8E6EF] flex items-center justify-center cursor-pointer'>
