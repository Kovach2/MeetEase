...
export default function IntroContent() {
    return (
        <div className="w-full max-w-[50%] flex flex-col items-center">
            ...
            <div className="mb-[25px] max-w-[600px] font-regular">MeetEase предлагает видеосвязь для работы и развлечений, где бы вы ни находились. Наслаждайтесь надежной связью и кристально чистым изображением в любой точке мира.</div>
